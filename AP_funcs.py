...
#====================================================================================================#
def cart_prod(list_of_lists): # return combinations of elements, each from a different set.
    # [[a,b,c],[d,e,f],[g,h], ...] converts to
    # [(a,d,g),(b,d,g),(c,d,g),(a,d,h),(b,d,h), ...]
    prod_list=list_of_lists[0]
    if len(list_of_lists)>1:
        for i in range(len(list_of_lists)-1):
            prod_list=list(itertools.product(prod_list,list_of_lists[i+1]))
            if i==0:
                pass
            else:
                set_list=prod_list
    ...
    return prod_list
#====================================================================================================#
def cart_dual_prod_re(list_of_lists):
    assert len(list_of_lists) == 2
    list_prod = cart_prod([list_of_lists[1], list_of_lists[0]])
    return [(one_pair[1], one_pair[0]) for one_pair in list_prod]
...
def test():
    ...
    print(cart_prod([[0,1,2,3,4,5],[0,2,4,6,8,]]))
    for i in cart_prod([[0,1,2,3,4,5],[0,2,4,6,8,]]):
        print(i)


    print(cart_dual_prod_re([[0,1,2,3,4,5],[0,2,4,6,8,]]))
    for i in cart_dual_prod_re([[0,1,2,3,4,5],[0,2,4,6,8,]]):
        print(i)
